...
public static void main(String[] args) {
	...
	public static double[][] montarMatriz(int NumVarDecisao,int numRestricao, double[][]MatrizRestricao,double[]FObjetiva)throws ArrayIndexOutOfBoundsException{
		int linha=numRestricao+1;
		int coluna=NumVarDecisao+numRestricao+1;
		double[][] tabela=new double[linha][coluna];
		...
		for(int i=0;i<NumVarDecisao;i++) tabela[numRestricao][i]=FObjetiva[i];
